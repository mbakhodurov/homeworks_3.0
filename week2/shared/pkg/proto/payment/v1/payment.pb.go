...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"payment.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xa5\x01\n" +
	"\x0fPayOrderRequest\x12(\n" +
	"\n" +
	"order_uuid\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\n" +
	"\x182R\torderUuid\x12&\n" +
	"\tuser_uuid\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\n" +
	"\x182R\buserUuid\x12@\n" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponse\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/api/v1/payment/pay_orderBPZNgithub.com/mbakhodurov/homeworks2/week2/shared/pkg/proto/payment/v1;payment_v1b\x06proto3"
