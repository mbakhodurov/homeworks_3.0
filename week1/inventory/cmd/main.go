...
import (
	...
	"github.com/mbakhodurov/homeworks2/week1/inventory/internal/interceptor"
	"github.com/mbakhodurov/homeworks2/week1/inventory/pkg/service"
	inventory_v1 "github.com/mbakhodurov/homeworks2/week1/shared/pkg/proto/inventory/v1"
...
func main() {
	...
	inventory_v1.RegisterInventoryServiceServer(grpcServer, service.NewServer())
