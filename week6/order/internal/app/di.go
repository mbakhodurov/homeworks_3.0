...
import (
	...
	orderapiv1 "github.com/mbakhodurov/homeworks2/week6/order/internal/api/order/v1"
	iamclient "github.com/mbakhodurov/homeworks2/week6/order/internal/client/grpc/iam/v1"
	inventoryclient "github.com/mbakhodurov/homeworks2/week6/order/internal/client/grpc/inventory/v1"
	paymentclient "github.com/mbakhodurov/homeworks2/week6/order/internal/client/grpc/payment/v1"
	"github.com/mbakhodurov/homeworks2/week6/order/internal/config"
	assemblyconsumer "github.com/mbakhodurov/homeworks2/week6/order/internal/consumer/assembly_consumer"
	"github.com/mbakhodurov/homeworks2/week6/order/internal/interceptor"
	"github.com/mbakhodurov/homeworks2/week6/order/internal/middleware"
	orderpayproducer "github.com/mbakhodurov/homeworks2/week6/order/internal/producer/order_producer"
	orderrepo "github.com/mbakhodurov/homeworks2/week6/order/internal/repository/order"
	orderitemrepo "github.com/mbakhodurov/homeworks2/week6/order/internal/repository/order_item"
	ordersvc "github.com/mbakhodurov/homeworks2/week6/order/internal/service/order"
	...
	kafkaproducer "github.com/mbakhodurov/homeworks2/week6/platform/pkg/kafka/producer"
	kafkamw "github.com/mbakhodurov/homeworks2/week6/platform/pkg/middleware/kafka"
	...
	paymentv1 "github.com/mbakhodurov/homeworks2/week6/shared/pkg/proto/payment/v1"
