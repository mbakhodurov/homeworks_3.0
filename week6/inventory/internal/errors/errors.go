...
var (
	...
	// ErrNothingToCommit деталь не зарезервирована или отсутствует на складе
	ErrNothingToCommit = errors.New("деталь не зарезервирована или отсутствует на складе")
)
