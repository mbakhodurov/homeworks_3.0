...
// UserUUID больше не передаётся в запросе — он берётся из контекста аутентифицированной
// сессии (см. service/order/create.go). Hull и Engine — обязательные слоты, Shield и
// Weapon — опциональные.
